...
Definition check_pre : bexp :=
  ...
  bvrands [::
             ...
             (bvrvar x12) <=r max; (bvrvar x12) <=r max;
             (bvrvar x14) <=r max;
             (bvrvar x20) <=r max; (bvrvar x21) <=r max;
             (bvrvar x22) <=r max; (bvrvar x22) <=r max;
             (bvrvar x24) <=r max;
             (bvrvar z20) <=r max; (bvrvar z21) <=r max;
             (bvrvar z22) <=r max; (bvrvar z22) <=r max;
             (bvrvar z24) <=r max;
             (bvrvar x30) <=r max; (bvrvar x31) <=r max;
             (bvrvar x32) <=r max; (bvrvar x32) <=r max;
             (bvrvar x34) <=r max;
             (bvrvar z30) <=r max; (bvrvar z31) <=r max;
             (bvrvar z32) <=r max; (bvrvar z32) <=r max;
             (bvrvar z34) <=r max
          ].
...
Definition x25519_x86_64_ladderstep_post1 :=
  ...
  bvands2
    ...
    [::
       ...
       (bvrvar x2'2) <=r max; (bvrvar x2'2) <=r max;
       (bvrvar x2'4) <=r max
    ] .
...
Definition x25519_x86_64_ladderstep_post2 :=
  ...
  [::
     ...
     (bvrvar z2'2) <=r max; (bvrvar z2'2) <=r max;
     (bvrvar z2'4) <=r max
  ] .
...
Definition x25519_x86_64_ladderstep_post3 :=
  ...
  bvands2
    ...
    [::
       ...
       (bvrvar x3'2) <=r max; (bvrvar x3'2) <=r max;
       (bvrvar x3'4) <=r max;
       (bvrvar z3'0) <=r max; (bvrvar z3'1) <=r max;
       (bvrvar z3'2) <=r max; (bvrvar z3'2) <=r max;
       (bvrvar z3'4) <=r max
    ] .
...
bvAddC carry rax (bvVar L0x603160) (bvVar rax);
(* add    0x202460(%rip),%r10        # 0x603168    #! EA = L0x603168 *)
bvAddC carry r10 (bvVar L0x603168) (bvVar r10);
(* add    0x202459(%rip),%r11        # 0x603168    #! EA = L0x603168 *)
bvAddC carry r11 (bvVar L0x603168) (bvVar r11);
(* add    0x202452(%rip),%r12        # 0x603168    #! EA = L0x603168 *)
bvAddC carry r12 (bvVar L0x603168) (bvVar r12);
(* add    0x20244b(%rip),%r13        # 0x603168    #! EA = L0x603168 *)
bvAddC carry r13 (bvVar L0x603168) (bvVar r13);
(* add    0x50(%rdi),%rsi                          #! EA = L0x7fffffffdae0 *)
bvAddC carry rsi (bvVar L0x7fffffffdae0) (bvVar rsi);
(* add    0x58(%rdi),%rdx                          #! EA = L0x7fffffffdae8 *)
bvAddC carry rdx (bvVar L0x7fffffffdae8) (bvVar rdx);
(* add    0x60(%rdi),%rcx                          #! EA = L0x7fffffffdaf0 *)
bvAddC carry rcx (bvVar L0x7fffffffdaf0) (bvVar rcx);
(* add    0x68(%rdi),%r8                           #! EA = L0x7fffffffdaf8 *)
bvAddC carry r8 (bvVar L0x7fffffffdaf8) (bvVar r8);
(* add    0x70(%rdi),%r9                           #! EA = L0x7fffffffdb00 *)
bvAddC carry r9 (bvVar L0x7fffffffdb00) (bvVar r9);
...
(* adc    %rdx,%rcx *)
bvAdcC carry rcx (bvVar rdx) (bvVar rcx) carry;
...
bvConcatShl rcx tmp (bvVar rcx) (bvVar rsi) (fromNat 13);
(* add    %r8,%rcx *)
bvAddC carry rcx (bvVar r8) (bvVar rcx);
(* and    %rdx,%rsi *)
(* NOTE: merged, see above *)
...
bvConcatShl rcx tmp (bvVar rcx) (bvVar r8) (fromNat 13);
(* add    %r10,%rcx *)
bvAddC carry rcx (bvVar r10) (bvVar rcx);
(* and    %rdx,%r8 *)
(* NOTE: merged, see above *)
...
bvConcatShl rcx tmp (bvVar rcx) (bvVar r9) (fromNat 13);
(* add    %r12,%rcx *)
bvAddC carry rcx (bvVar r12) (bvVar rcx);
(* and    %rdx,%r9 *)
(* NOTE: merged, see above *)
...
bvConcatShl rcx tmp (bvVar rcx) (bvVar rax) (fromNat 13);
(* add    %r14,%rcx *)
...
bvConcatShl rcx tmp (bvVar rcx) (bvVar r10) (fromNat 13);
(* imul   $0x13,%rcx,%rcx *)
...
bvAddC carry rsi (bvVar L0x603160) (bvVar rsi);
(* add    0x20205b(%rip),%rdx        # 0x603168    #! EA = L0x603168 *)
bvAddC carry rdx (bvVar L0x603168) (bvVar rdx);
(* add    0x202054(%rip),%rcx        # 0x603168    #! EA = L0x603168 *)
bvAddC carry rcx (bvVar L0x603168) (bvVar rcx);
(* add    0x20204d(%rip),%r8        # 0x603168     #! EA = L0x603168 *)
bvAddC carry r8 (bvVar L0x603168) (bvVar r8);
(* add    0x202046(%rip),%r9        # 0x603168     #! EA = L0x603168 *)
bvAddC carry r9 (bvVar L0x603168) (bvVar r9);
...
bvAddC carry rsi (bvVar L0x7fffffffdb30) (bvVar rsi);
(* add    0xa8(%rdi),%rdx                          #! EA = L0x7fffffffdb38 *)
bvAddC carry rdx (bvVar L0x7fffffffdb38) (bvVar rdx);
(* add    0xb0(%rdi),%rcx                          #! EA = L0x7fffffffdb40 *)
bvAddC carry rcx (bvVar L0x7fffffffdb40) (bvVar rcx);
(* add    0xb8(%rdi),%r8                           #! EA = L0x7fffffffdb48 *)
bvAddC carry r8 (bvVar L0x7fffffffdb48) (bvVar r8);
(* add    0xc0(%rdi),%r9                           #! EA = L0x7fffffffdb50 *)
bvAddC carry r9 (bvVar L0x7fffffffdb50) (bvVar r9);
...
(* shr    $0x33,%rcx *)
(* NOTE: merge 'shr $0x33,%rcx' with 'and %rdx,%rsi' *)
bvConcatShl rcx tmp0 (bvVar rcx) (bvVar rsi) (fromNat 13);
(* add    %r8,%rcx *)
bvAddC carry rcx (bvVar r8) (bvVar rcx);
(* mov    %rcx,%r8 *)
bvAssign r8 (bvVar rcx);
(* shr    $0x33,%rcx *)
(* NOTE: merge 'shr $0x33,%rcx' with 'and %rdx,%r8' *)
bvConcatShl rcx tmp1 (bvVar rcx) (bvVar r8) (fromNat 13);
(* and    %rdx,%rsi *)
(* NOTE: merged, see above *)
...
(* shr    $0x33,%rcx *)
(* NOTE: merge 'shr $0x33,%rcx' with 'and %rdx,%r9' *)
bvConcatShl rcx tmp0 (bvVar rcx) (bvVar r9) (fromNat 13);
(* and    %rdx,%r8 *)
(* NOTE: merged, see above *)
...
(* shr    $0x33,%rcx *)
(* NOTE: merge 'shr $0x33,%rcx' with 'and %rdx,%rax' *)
bvConcatShl rcx tmp1 (bvVar rcx) (bvVar rax) (fromNat 13);
(* and    %rdx,%r9 *)
(* NOTE: merged, see above *)
...
(* shr    $0x33,%rcx *)
(* NOTE: merge 'shr $0x33,%rcx' with 'and %rdx,%r10' *)
bvConcatShl rcx tmp0 (bvVar rcx) (bvVar r10) (fromNat 13);
(* and    %rdx,%rax *)
(* NOTE: merged, see above *)
...
bvAddC carry rdx (bvVar L0x603160) (bvVar rdx);
...
bvAddC carry rsi (bvVar L0x7fffffffd958) (bvVar rsi);
(* add    0x30(%rsp),%r8                           #! EA = L0x7fffffffd960 *)
bvAddC carry r8 (bvVar L0x7fffffffd960) (bvVar r8);
(* add    0x38(%rsp),%r9                           #! EA = L0x7fffffffd968 *)
bvAddC carry r9 (bvVar L0x7fffffffd968) (bvVar r9);
(* add    0x40(%rsp),%rax                          #! EA = L0x7fffffffd970 *)
bvAddC carry rax (bvVar L0x7fffffffd970) (bvVar rax);
(* add    0x48(%rsp),%r10                          #! EA = L0x7fffffffd978 *)
bvAddC carry r10 (bvVar L0x7fffffffd978) (bvVar r10);
...
(* add    %rdx,%rsi *)
bvAddC carry rsi (bvVar rdx) (bvVar rsi);
(* add    0x50(%rsp),%rsi                          #! EA = L0x7fffffffd980 *)
bvAddC carry rsi (bvVar L0x7fffffffd980) (bvVar rsi);
(* add    0x58(%rsp),%rcx                          #! EA = L0x7fffffffd988 *)
bvAddC carry rcx (bvVar L0x7fffffffd988) (bvVar rcx);
(* add    0x60(%rsp),%r8                           #! EA = L0x7fffffffd990 *)
bvAddC carry r8 (bvVar L0x7fffffffd990) (bvVar r8);
(* add    0x68(%rsp),%r9                           #! EA = L0x7fffffffd998 *)
bvAddC carry r9 (bvVar L0x7fffffffd998) (bvVar r9);
(* add    0x70(%rsp),%r10                          #! EA = L0x7fffffffd9a0 *)
bvAddC carry r10 (bvVar L0x7fffffffd9a0) (bvVar r10);

...
Lemma valid_x25519_x86_64_ladderstep3_2 : 
  valid_bvspec (check_inputs, x25519_x86_64_ladderstep_spec3_2).
Proof.
  split .
  Focus 2 .
  apply: bvSSA.ssa_spec_sound.
  apply bvSSA2zSSA.bv2z_spec_sound .
  Focus 3 .
  bvVerify.verify_bv2zssa_with (oconf [::]) check_inputs .

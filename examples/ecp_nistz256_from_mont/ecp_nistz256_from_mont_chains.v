...
Definition nistz256_from_mont_spec :=
  {| spre := check_pre;
     sprog := program;
     spost := nistz256_from_mont_post |}.

Lemma valid_nistz256_from_mont :
  valid_bvspec (check_inputs, nistz256_from_mont_spec).
Proof.
  time "valid_nistz256_from_mont" verify_bvspec .
Qed.

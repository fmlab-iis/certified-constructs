...
\newcommand{\qExp}{\mathit{qExp}}
\newcommand{\qPred}{\mathit{qPred}}
\newcommand{\bvconst}{\dslcode{bvconst}}
\newcommand{\bvadd}{\dslcode{bvadd}}
\newcommand{\bvsub}{\dslcode{bvsub}}
\newcommand{\bvmul}{\dslcode{bvmul}}
\newcommand{\bvnot}{\dslcode{bvnot}}
\newcommand{\bvshl}{\dslcode{bvshl}}
\newcommand{\bvlshr}{\dslcode{bvlshr}}
\newcommand{\bvextract}{\dslcode{bvextract}}
\newcommand{\bvconcat}{\dslcode{concat}}
\newcommand{\bvhigh}{\dslcode{bvhigh}}
\newcommand{\bvlow}{\dslcode{bvlow}}
\newcommand{\bvext}{\dslcode{zero\_extend}}
\newcommand{\bvult}{\dslcode{bvult}}
\newcommand{\bvule}{\dslcode{bvule}}
\newcommand{\width}{\mathit{width}}
\newcommand{\extbvadd}{\dslcode{ext\_bvadd}}
\newcommand{\extbvadc}{\dslcode{ext\_bvadc}}
\newcommand{\extbvsub}{\dslcode{ext\_bvsub}}
\newcommand{\extbvsbb}{\dslcode{ext\_bvsbb}}
\newcommand{\extbvmul}{\dslcode{ext\_bvmul}}
\newcommand{\concatshl}{\dslcode{concat\_shl}}
\newcommand{\bvSucc}{\mathit{bSucc}}
\newcommand{\zSucc}{\mathit{zSucc}}
\makeatletter
...
\newcommand{\StatexIndent}[1][3]{%
  \setlength\@tempdima{\algorithmicindent}%
  \Statex\hspace{0.5mm}\hskip\dimexpr#1\@tempdima\relax}
\makeatother

...
with addition and multiplication modulo $\varrho$ forms a \emph{Galois
...
of the ideal $\langle G \rangle$. Given an ideal $I$ and
$f \in \mathcal{R}[\vx]$, the \emph{ideal membership}

...
The following \mydsl code implements multiplications over $\bbfGF(2^{255}-19)$ for the AMD64 architecture:
...
4 &: \concat{\mathit{mulrdx}}{\mathit{mulrax}} \leftarrow & \dslcode{Split}(\mathit{mulrax} \times \mathit{y2}, 64); \\
...
10 &: \concat{\mathit{mulrdx}}{\mathit{mulrax}} \leftarrow & \dslcode{Split}(\mathit{mulrax} \times \mathit{y1}, 64); \\
11 &: \mathit{r0} \leftarrow & \mathit{r0} + \mathit{mulrax}; \\
12 &: \concat{\mathit{carry}}{\mathit{r0}} \leftarrow & \dslcode{Split}(\mathit{r0}, 64); \\
13 &: \mathit{mulr01} \leftarrow & \mathit{mulr01} + \mathit{mulrdx} + \mathit{carry}; \\
14 &: \mathit{mulrax} \leftarrow & \mathit{x0}; \\
15 &: \concat{\mathit{mulrdx}}{\mathit{mulrax}} \leftarrow & \dslcode{Split}(\mathit{mulrax} \times \mathit{y0}, 64); \\
16 &: \mathit{r0} \leftarrow & \mathit{r0} + \mathit{mulrax}; \\
17 &: \concat{\mathit{carry}}{\mathit{r0}} \leftarrow & \dslcode{Split}(\mathit{r0}, 64); \\
